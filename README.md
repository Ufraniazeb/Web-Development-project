					...
					<tr>
						...
						<td width="60%">
							<font face="Verdana" size="4"
								...
								website.
								<hr color="black">
								Urania Zeb Here i am  Ufrania Sardar 
                An Electronics Engineering Student At Air university,
                Currently i'm in my fifth symester
                 <div class=""></div>
								<hr color="black">
								...
								built using HTML only.I do this for internship at BharatInterns
                        ...
                        Engineering.
									...
									<li>
										...
										<ul>
											...
											<li>
												I'm paying my Duties on  different platforms Like Fiver, Upwork and 
